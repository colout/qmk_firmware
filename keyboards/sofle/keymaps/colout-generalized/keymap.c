...
[_LOWER] = LAYOUT( \
  ...
  _______,   _______,   _______,    _______,    KC_LPRN,    KC_RPRN,                      KC_7,       KC_8,       KC_9,       KC_MINS,    KC_F12,       KC_DEL, \
  KC_A,   KC_BACKSLASH,   KC_MINS,    KC_EQL,     KC_LBRC,    KC_RBRC,                      KC_4,       KC_5,       KC_6,       KC_PLUS,    _______,      _______, \
